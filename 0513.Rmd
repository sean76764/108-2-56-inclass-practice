...
正確接法：
```{r}
factor1[4:6] <- factor2##取出不存在把factor2加入
factor1
```
...
extract_data <- str_extract(garbageRoutes$linename, strip01)
garbageRoutes$route <- factor(unlist(extract_data))
```
