...
```{r ans21}
pick_1 <- semiGodsSemiDevils$data[[1]]$section == "P2"
context_picked <- semiGodsSemiDevils$data[[1]]$text[pick_1]
context_picked
```
...
```{r ans23}
mention_duan <- str_extract_all(context_picked_split[[1]],
                "姓段的小子|段(譽|兄|兄弟|大哥|相公|君)")
mention_duan
```
