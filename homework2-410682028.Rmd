...
```{r ans32}
as.numeric(Pikachu$baseStats) ->Pikachu_stats
class(Pikachu_stats)
Pikachu_stats
```
...
Mimikyu$fastMoves <- Jigglypuff$fastMoves
Mimikyu$chargedMoves <- Jigglypuff$chargedMoves
Mimikyu$legacyMoves <- Jigglypuff$legacyMoves
